...
const Drawer = ({ className, children, open, onOpenChange, ...props }: DrawerRootProps) => {
  return (
    <div
...
const DrawerTrigger = (props: React.ButtonHTMLAttributes<HTMLButtonElement>) => (
  <button {...props} />
)

const DrawerPortal = ({ children }: { children: React.ReactNode }) => <>{children}</>

const DrawerClose = (props: React.ButtonHTMLAttributes<HTMLButtonElement>) => (
  <button {...props} />
)
